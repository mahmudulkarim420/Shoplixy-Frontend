  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900">
        ...
        <Image
          src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&h=1600&fit=crop"
        ...
        <div className="relative z-20 flex flex-col justify-between h-full p-16 text-white">
          ...
          <div>
            ...
            >
              Elevate Your <br />
              <span className="text-indigo-400">Digital Realm.</span>
            </h2>
            <p className="text-slate-300 max-w-md text-lg leading-relaxed">
              Login to access your premium collection, track global shipping, and witness exclusive
              drops.
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 transition-all font-medium shadow-sm"
